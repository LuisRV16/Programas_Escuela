...
public class IFrameTrapIsos extends javax.swing.JInternalFrame implements ActionListener{
    CTrapecioIsos A = new CTrapecioIsos();
    private JLabel baseMay,baseMen,altura;
    private JTextField txtBaseMay,txtBaseMen,txtAltura;
    private JTextArea resultados;
    private JButton calcular;
    public IFrameTrapIsos() {
        initComponents();
        setLayout(null);
        ...
        txtBaseMay.setFont(new Font("Andale Mono",2,18));
        add(txtBaseMay);
        txtBaseMen = new JTextField();
        txtBaseMen.setBounds(150,50,100,30);
        txtBaseMen.setFont(new Font("Andale Mono",2,18));
        add(txtBaseMen);
        txtAltura = new JTextField();
        txtAltura.setBounds(150,90,100,30);
        txtAltura.setFont(new Font("Andale Mono",2,18));
        add(txtAltura);
        resultados = new JTextArea();
        resultados.setBounds(25,120,400,100);
        resultados.setFont(new Font("Andale Mono",1,18));
            ...
            if (e.getSource()==calcular) {
                ...
                if (l1<=l2) {
                    JOptionPane.showMessageDialog(this, "La base mayor debe ser el mayor valor en relacion a las bases"
                            + "\npara cumplir con las características del trapecio.\nIngrese valores validos");
                    txtBaseMay.setText("");
                    txtBaseMen.setText("");
                    txtAltura.setText("");
                    resultados.setText("");
